...
curl -s -v                          http://localhost:$AREX_PORT/document.html > $AREX_RUN_DIR/out.1 2>&1
curl -s -v -H 'Accept-Language: en' http://localhost:$AREX_PORT/document.html > $AREX_RUN_DIR/out.2 2>&1
curl -s -v -H 'Accept-Language: fr' http://localhost:$AREX_PORT/document.html > $AREX_RUN_DIR/out.3 2>&1
