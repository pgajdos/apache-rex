...
returned_string=$(curl -s http://localhost:$AREX_RUN_PORT2/pangrams/czech.html)
...
returned_string=$(curl -s http://localhost:$AREX_RUN_PORT3/pangrams/german.html)
echo original string: $utf8_string
echo returned string: $returned_string
...
returned_string=$(curl -s http://localhost:$AREX_RUN_PORT5/pangrams/slovak.html)
echo original string: $utf8_string
echo returned string: $returned_string
