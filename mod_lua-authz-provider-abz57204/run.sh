...
curl -s http://localhost:$AREX_PORT1/notexisting.html > /dev/null
curl -s http://localhost:$AREX_PORT1/dir/notexisting.html > /dev/null
curl -s http://localhost:$AREX_PORT2/notexisting.html > /dev/null
curl -s http://localhost:$AREX_PORT2/dir/notexisting.html > /dev/null
