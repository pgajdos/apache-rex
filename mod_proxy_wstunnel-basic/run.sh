...
# use $AREX_RUN_PORT1 port for this server
...
python $AREX_RUN_DIR/ws-test-client.py --url="ws://127.0.0.1:$AREX_RUN_PORT/" > result-with-proxy
python $AREX_RUN_DIR/ws-test-client.py --url="ws://127.0.0.1:$AREX_RUN_PORT1/reverse-echo/" > result-without-proxy
